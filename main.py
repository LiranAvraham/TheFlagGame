...
from game_field import character_image
...
def count_remaining_diamonds(grid):
    ...
    for row in grid:
        for cell in row:
            # cell must be compared to int not "2" String
            if cell == 2:
                count += 1
    return count
...
def main():
    ...
    while running:
        ...
        for event in pygame.event.get():
            ...
            # The order of the action is wrong
